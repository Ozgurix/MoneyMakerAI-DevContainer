...
export AWS_ACCESS_KEY_ID=$(kubectl get secret aiw-secret -o jsonpath='{.data.AWS_ACCESS_KEY_ID}' | base64 --decode)
export AWS_SECRET_ACCESS_KEY=$(kubectl get secret aiw-secret -o jsonpath='{.data.AWS_SECRET_ACCESS_KEY}' | base64 --decode)
